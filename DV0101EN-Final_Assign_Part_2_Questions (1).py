...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
        ...
        R_chart3 = dcc.Graph(figure=px.pie(exp_rec, values='Advertising_Expenditure', names='Vehicle_Type', title="Expediture Share by Vehicle Type During Recession"))

# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        unp_data=recession_data.groupby(['Vehicle_Type', 'unemployment_rate'])['Automobile_Sales'].mean().reset_index()
        R_chart4 = dcc.Graph(figure=px.bar(unp_data, x='unemployment_rate', y='Automobile_Sales', color='Vehicle_Type', labels={"Unemployment_Rate":"Unemployment_Rate", "Automobile_Sales":"Average automobile sales"}, title="Effect of Unemployment Rate on Vehicle type and sale" ))   ...................
